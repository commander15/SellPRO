@extends('common.view', [
    'id' => 'sellers',
    'title' => 'Add Seller',
    'sub_title' => 'Add a seller to the team !'
])
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            <div class="card shadow-lg border-0 rounded-lg mt-5">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/sellers') }}">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input class="form-control" id="inputLastName" name="first_name" type="text" placeholder="Enter your last name">
